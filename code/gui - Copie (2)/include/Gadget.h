...
public:
    ...
    ///< Definir m_parent
    void setParent( std::shared_ptr<Conteneur> val );

    ///< Acceder à m_parent
    std::shared_ptr<Conteneur> getParent () const;
    ...
    ///< Renvois un pointeur vers this
    ptr getThisPtr() { return std::static_pointer_cast<Gadget>( shared_from_this() ); };
