...
public:
    ...
    ///
    /// \param delta le temps écoulé depuis la dernièe actualisation
    /////////////////////////////////////////////////
...
private:
    ...
    sf::RenderWindow*       m_fenetre;                      ///< La fenetre SFML oÃ¹ s'affiche l'interface.
    sf::RenderTarget*       m_cible;                        ///< La fenetre SFML oÃ¹ s'affiche l'interface.
