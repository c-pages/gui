...
private:
    ...
    sf::Color m_texteCouleurNormal;    ///<
    sf::Color m_texteCouleurSurvole;    ///<
    sf::Color m_texteCouleurPresse;    ///<
    sf::Color m_fondCouleurNormal;    ///<
    sf::Color m_fondCouleurSurvole;    ///<
    sf::Color m_fondCouleurPresse;    ///<
    std::shared_ptr<sf::Texture> m_textureNormal;    ///<
    std::shared_ptr<sf::Texture> m_textureSurvol;    ///<
    std::shared_ptr<sf::Texture> m_texturePresse;    ///<
