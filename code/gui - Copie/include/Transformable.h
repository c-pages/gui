...
/////////////////////////////////////////////////
private:
    Vec2 m_position;    ///< La position du gadget dans le fanetre. #G#S
    int m_profondeur;    ///< La profondeur du gadget. (0: fond) #G#S
    Vec2 m_taille;    ///< La taille du gadget (en pixel). #G
