...
//    m_interface->demander_actualisation ();
...
EcranDemo::initGUI_test_Fenetres  ()
{
    ...
    /////// TITRE Label ///////
    m_labelTitre_4 = m_interface->creer.label( "Fenêtres" );
...
//    m_boutonTexte->demander_actualisation ();
...
EcranDemo::initGUI_test_Affichages  ()
{
    ...
    m_rectangle->setStyle       ( m_skin->getStyle (  gui::Styles::fond ) );
